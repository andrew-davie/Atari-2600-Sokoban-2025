...
// detectConsoletype() is called every frame, but actually only 'triggers' detection on frame 10
// This code will autodetect for SECAM, PAL, NTSC on both 60 MHz and 70 MHz ARM variants.
